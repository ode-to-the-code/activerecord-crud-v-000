...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.new(title:attributes[:title], release_date:attributes[:release_date], director:attributes[:director], lead:attributes[:lead],
...
def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by
  # release date descending
  # SELECT * FROM movies WHERE release_date > 2002 ORDER BY DESC release_date
